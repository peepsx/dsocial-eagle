...
router.post('/transfer', async (req, res) => {
    let { send, receive, sender_username, receiver_username, amount } = req.body;
    if(!sender_username || !receiver_username || !amount || !send) return res.status(401).send({success: false, message: 'Field are missing'});
