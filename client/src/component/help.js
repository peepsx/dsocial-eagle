            ...
            <div className="modal-content bg-white">
                ...
                <div className="modal-body py-1">
                    <div className="py-2 pl-3 pr-3">
                        <p className="h5 mt-2 mb-2"> Air-Drop Setup (Step-1)</p>
                        <p className="mb-0 fs-1">1. User have to login with all four platforms serially (Facebook -> Twitter -> Instagram -> Google).</p>
                    ...
                    <div className="py-2 pl-3 pr-3">
                        <p className="h5 mt-2 mb-2"> Follow Arisen (Step-2)</p>
                        <p className="mb-0 fs-1">1. After successfully done "Air-Drop Setup" step then user have to Like Arisen's Facebook page.</p>
                        ...
                        <p className="mb-0 fs-1">4. After Instagram, User have to Subscribe Arisen Youtube Channel.</p>
                    ...
                    <div className="py-2 pl-3 pr-3">
                        <p className="h5 mt-2 mb-2"> Share with Friends (Step-3)</p>
                        <p className="mb-0 fs-1">1. After successfully done "Follow Arisen" step then user have to Share pre-written post on Facebook.</p>
                    ...
                    <div className="py-2 pl-3 pr-3">
                        ...
                        <p className="mb-0 fs-1">1. After successfully done "Share with Friends" step then user have to enter Arisen Account to recieve bonus RIX.</p>
                    ...
                    <div className="py-2 pl-3 pr-3">
                        <p className="h5 mt-2 mb-2"> Recieve Free Coins</p>
