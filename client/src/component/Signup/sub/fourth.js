            ...
            <div className="card-body p-4 px-lg-5">
                <div className="mb-4 text-center">
                    ...
                    <div className="custom-control custom-checkbox mb-3">
                        <input type="checkbox" className="custom-control-input" id="privact-policy-agree1" />
                        <label className="custom-control-label" htmlFor="privact-policy-agree">I have read and agree to the Privacy Policy</label>
                    </div>
                    <button className="btn btn-primary sw-btn-next" type="button">Submit Planner</button>
                </div>
            </div>
        )
    }
