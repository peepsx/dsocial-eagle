        ...
        return (
            <div className="card-body p-4 px-lg-5">
                <div className=" text-center">
                    ...
                    <a className="d-block mb-2 mt-2" href={`https://data.arisen.network/accounts/${username}`} target="_blank" rel="noopener noreferrer">Click here to see your transaction</a>
