...
export default class Instagram extends React.Component {
    ...
    handleInstaClick = () => {
        if (this.state.instaCode === "") {
            window.open(`https://api.instagram.com/oauth/authorize?client_id=${env.instagram_client_id}&redirect_uri=https://air.arisen.network/&scope=user_profile,follower_list&response_type=code`, "_self")
        }
    }
